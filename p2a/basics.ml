...
let mult_of_y x y = failwith "unimplemented"

let head_divisor lst = failwith "unimplemented"

let second_element lst = failwith "unimplemented"

let sum_first_three lst = failwith "unimplemented"
...
let rec get_val i lst = failwith "unimplemented"

let rec get_vals is lst = failwith "unimplemented"

let rec list_swap_val lst x y = failwith "unimplemented"
